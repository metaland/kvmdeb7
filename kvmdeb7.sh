...
# set repo
wget -O /etc/apt/sources.list "https://raw.githubusercontent.com/metaland/kvmdeb7/master/sources.list.debian7"
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/metaland/kvmdeb7/master/nginx.conf"
mkdir -p /home/vps/public_html
wget -O /home/vps/public_html/index.html "http://vpsscript.hol.es/index.html"
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/metaland/kvmdeb7/master/vps.conf"
sed -i 's/listen = \/var\/run\/php5-fpm.sock/listen = 127.0.0.1:9000/g' /etc/php5/fpm/pool.d/www.conf
service php5-fpm restart
service nginx restart

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/metaland/kvmdeb7/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/metaland/kvmdeb7/master/1194.conf"
service openvpn restart
sysctl -w net.ipv4.ip_forward=1
sed -i 's/#net.ipv4.ip_forward=1/net.ipv4.ip_forward=1/g' /etc/sysctl.conf
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/metaland/kvmdeb7/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/metaland/kvmdeb7/master/1194-client.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/metaland/kvmdeb7/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/metaland/kvmdeb7/master/badvpn-udpgw64"
fi
...
curl "https://raw.githubusercontent.com/metaland/kvmdeb7/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget -O /etc/squid3/squid.conf "https://raw.githubusercontent.com/metaland/kvmdeb7/master/squid3.conf"
...
wget -O bench-network.sh  "https://raw.githubusercontent.com/metaland/kvmdeb7/master/bench-network.sh"
...
# info
clear
echo "Original Script By KangArie Dan Mikodemos| Edited By Metaland | tee log-install.txt
...
echo ""  | tee -a log-install.txt
echo "VPS AKAN REBOOT SEHARI SEKALI !"  | tee -a log-install.txt
